              ...
              <div class="navArea">
                <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                    <li class="menuItem"><a href="index.php?controller=Pincho&amp;action=listarTodosPinchosValidados">Generar codigos de pincho</a></li>
                    <li class="menuItem"><a href="index.php?controller=Pincho&amp;action=add">Añadir un Pincho</a></li>
                    <li class="menuItem"><a href="#gallery">ESTOESALDMIN</a></li>                    
